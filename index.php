...
<html lang="en">
  ...
  <body>
    <div class="header">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-2">
            <img src="images/front_image1.jpg" alt="#" />
          </div>
        </div>
        <!-- ==== end first section ==== -->
      </div>
    ...
    <!-- ==== featured categories ==== -->
    <div class="categories" id="featured-products">
    ...
    <div class="small-container">
      ...
      <div class="row">
        <div class="col-4">
          <img src="images/product-1.jpeg" alt="" height="300px" />
        ...
        <div class="row">
          <div class="col-3">
            ...
            <p>
              ...
              odio vero! Animi ea accusamus non, recusandae aperiam, architecto,
              hic magnam laborum maxime corporis sequi alias vero nesciunt
              numquam nemo nam!
            </p>
            <div class="rating">
              <i class="fa fa-star"></i>
